              ...
              <Flex direction={'column'}>
                <Flex justify={'space-between'}>
                  <div>
                    ...
                    {editing && (
                      <FormControl>
                        <FormLabel color={'white'}> Book Cover</FormLabel>
                        <Input
                          type="file"
                          color={'white'}
                          onChange={(e) => setEditedValues({ ...editedValues, cover: e.target.files[0], })}
                        />
                      </FormControl>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <ButtonGroup>
                      ...
                      {editing ? (
                        <>
                          <Button variant={'outline'} color={'white'} _hover={blur} onClick={handleSaveClick}>
                            Save
                          </Button>
                          {!groups[0]?.status ? (
                        ...
                        <>
                          <Button variant={'outline'} color={'white'} _hover={blur} onClick={handleEditClick}>
                            Edit
                          </Button>
                          {!groups[0]?.status ? (
                            <Button onClick={handleStatusClick}>End Group</Button>
                  ...
                  <div>
                    ...
                    {editing && (
                      <FormControl>
                        <FormLabel color={'white'}>Team Logo</FormLabel>
                        <Input
                          color={'white'}
                          type="file"
                          onChange={(e) => setEditedValues({ ...editedValues, logo: e.target.files[0], })}
                        />
                      </FormControl>
                    )}
                  </div>
                </Flex>
                {/* ROSTER AND ESSAY COMPONENTS BELOW */}
